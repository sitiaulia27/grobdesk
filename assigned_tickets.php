    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">List Assigned Tickets</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                ...
                <table class="table dTable table-bordered w-100 table-striped table-responsive">
                  <thead>
                    ...
                    <th width="1%"><strong>No</strong></th>
                      ...
                      <th width="15%"><strong>Modified</strong></th>
                      <td width="20%"><strong>Action</strong></th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php
  ...
  <script>
    $(function() {
     ...
     let dataTable =  $('.table').DataTable({
        ...
        "ajax": {
          "url": "ajax/ajax_assignedticket.php?action=table_data",
          "dataType": "json",
          "type": "POST",
          'data': function(data) {
            // Read values
